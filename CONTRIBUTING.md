...
You may need to authenticate with GitHub to pull `docker.pkg.github.com/sunguohua/grpc-gateway/build-env`.
...
1. Tag the release on `main`.
   1. The release can be created using the command line, or also through GitHub's [releases
      UI](https://github.com/sunguohua/grpc-gateway/releases/new).
